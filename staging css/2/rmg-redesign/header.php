			...
			<?php endif; // true === $et_contact_info_defined ?>
				...
				<div class="logo-new">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="/wp-content/uploads/rmg-max-logo.png">
					</a>
				</div>
			</div> <!-- .container -->
		</div> <!-- #top-header -->
		...
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
				<div class="logo_container">
					...
					<a href="http://rmgnetworks.com/" target="_blank">
						<img src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
				</div>
				<div class="logo_container logo_container_scroll">
					<span class="logo_helper"></span>
					<a href="http://rmgnetworks.com/" target="_blank">
						<img src="/wp-content/uploads/rmg-logo.png" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
				</div>
