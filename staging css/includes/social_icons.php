...
<li class="et-social-icon et-social-linkedin">
	<a href="https://www.linkedin.com/company/rmg-networks" class="icon">
		<span><?php esc_html_e( 'Google', 'Divi' ); ?></span>
	</a>
</li>
<li class="et-social-icon et-social-youtube">
	<a href="https://www.youtube.com/channel/UCAghzLiR8g7TFGO-2KF_JHA" class="icon">
		<span><?php esc_html_e( 'Google', 'Divi' ); ?></span>
	</a>
</li>
...
<li class="et-social-icon et-social-instagram">
	<a href="https://www.instagram.com/rmgnetworks/" class="icon">
		<span><?php esc_html_e( 'Google', 'Divi' ); ?></span>
	</a>
</li>
